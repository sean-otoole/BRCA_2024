...
```{r display_Ma_2024, echo=FALSE}
current_metric <- "Goff_Agpresentation"
plot_path <- paste0(getwd(), '/figures/', current_metric, 'ma_et_al_umaps.png')
knitr::include_graphics(plot_path)
```
...
```{r grab_Gene, echo=FALSE, fig.show='hide',results ='hide'}
# Specify the path to the R script
script_path <- paste0(getwd(), '/spatial_metric_description.r')
# Run the R script
source(script_path)
current_metric <- "FCRL5"
